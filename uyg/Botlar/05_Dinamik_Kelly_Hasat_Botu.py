...
- Dinamik Kaldıraç (Kelly): Yapay Zeka bir işleme çok güveniyorsa (Örn: %85+)
  8x'e kadar yüksek kaldıraç açar. Eğer az güveniyorsa (Örn: %60) daha düşük 
...
HARVEST_TARGET = 120.0            # 120 dolara ulaşınca 20 Dolar Nakit çek
...
def backtest_kelly_harvest(rows, P, starting_bankroll=100.0):
    ...
    for i,r in enumerate(rows):
        ...
        dynamic_leverage = min(8.0, kelly_fraction * 15.0)
...
def main():
    ...
    print("  Kural: Olasılığa Göre Kaldıraç Bas, 120 Dolarda Nakit Çek!")
    print(f"  Max Kaldıraç Sınırı: 8.0x  |  Ulaşılan En Yüksek: {r['max_lev']:.1f}x")
    print("==========================================================")
