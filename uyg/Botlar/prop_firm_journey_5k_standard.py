#!/usr/bin/env python3
"""
ÖZEL 5K PROP FIRM SİMÜLATÖRÜ - STANDART KURALLAR (5% Daily DD, 10% Max DD)
Bu simülatör, görseldeki $36'lık yeni şartlara göre uyarlanmıştır:
- Kasa: $5.000
- Hedefler: %8 Phase 1, %5 Phase 2
- Max Daily DD: -%5 (Eski klasik güvenli limit!)
- Max Total DD: -%10
- Güvenlik: max_kelly_lev = 1.5 (Eski tam güç kullanıma geri dönüş!)
"""
...
MAX_DAILY_DD_PCT = 0.05 # GÖRSELDEKİ -%5 ŞARTI
MAX_TOTAL_DD_PCT = 0.10 # GÖRSELDEKİ -%10 ŞARTI
...
def run_journey(rows, P, gate_top=0.20, start_date_str="2024-12-01", max_kelly_lev=1.5, payout_threshold=None):
    ...
    for i,r in enumerate(rows):
        ...
        # Kâr Tamponu (Drawdown Koruması - -%10 Limit için)
...
def main():
    ...
    print("="*85)
    print(" 🏙️  WALL STREET: 5K STANDART PROP FIRM ($36 - %5 DAILY DD) SİMÜLASYONU 🏙️")
    print("="*85)
