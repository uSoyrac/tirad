...
NORMAL_BET_FRACTION = 0.25
RECOVERY_BET_FRACTION = 0.50
OPTIMAL_THRESHOLD = 0.70
RECOVERY_THRESHOLD = 0.75

def run_v65_top5():
    print("🌟 V65 TOP-5 COIN 6-AYLIK SÜPER SİMÜLASYON BAŞLIYOR...")
    ...
    # Train on everything BEFORE Dec 2025
    train_df = valid_df[valid_df['ts'] < '2025-12-01']
    
    # Test on the last 6 months (Dec 2025 to June 2026)
    test_df = valid_df[valid_df['ts'] >= '2025-12-01']
    ...
    print("Ajan 4 (AI), Top-5 Coindeki Balina Algoritmalarını 2024-2025 verisiyle Eğitiyor...")
    ...
    print("Son 6 ay (2025 Aralık - 2026 Haziran) OOS Kör Test Hesaplanıyor...")
    test_features = test_df[features].fillna(0)
    ai_probs = model_ai.predict_proba(test_features)[:, 1]
    
    # Kopyasını alıyoruz ki "SettingWithCopyWarning" vermesin
    ...
    print("\n--- V65 TOP-5 COIN: 6 AYLIK KÖR TEST HAFTALIK RAPOR ---")
    ...
    print(f"\n🏆 V65 6-AYLIK HIZLI COMPOUND ÖZETİ 🏆")
