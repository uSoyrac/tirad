...
NORMAL_BET_FRACTION = 0.30
RECOVERY_BET_FRACTION = 0.60
...
def run_v65_top5_optimal():
    print("🌟 V65 TOP-5 COIN 6-AYLIK MTF SÜPER SİMÜLASYON BAŞLIYOR...")
    ...
    print("Ajan 4 (AI), Top-5 Coindeki Balina Algoritmalarını Eğitiyor...")
    ...
    print("Son 6 ay (2025 Aralık - 2026 Haziran) KÖR TEST Hesaplanıyor...")
    ...
    # 🌟 KUTSAL KASE MTF FİLTRESİ EKLENDİ 🌟
    test_df['macro_ok'] = (
        ...
        (test_df['ts'].dt.weekday < 5) & 
        (test_df['ts'].dt.hour.isin([13, 14, 15, 16, 17, 18, 19, 20])) &
        (test_df['adx_1h'] > 20)
    )
    ...
    print(f"\n🏆 V65 6-AYLIK MTF SÜPER COMPOUND ÖZETİ 🏆")
