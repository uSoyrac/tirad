...
class SignalEngine:
    ...
    def analyze(
        ...
        cs = confluence_scorer.score(df, ms, oi_list, px_list, funding)

        # ── Adım 6: Tam hard gate değerlendirmesi ─────────────────
    ...
    def _fetch_oi_funding(
        ...
        """OI ve Funding Rate verisi çeker. Başarısızsa (None, None, None)."""
        try:
